...
# Output directory
OUTPUT_DIR = "/data/ep924610/project_nb/paper_code/bulk_review/new_prompt2"
...
3. Expression Difference: Z-score difference between malignant vs. normal cells from differential gene epression in bulk data
...
def extract_gene_data(response_text, model_name=None, run_id=None):
    ...
    gene_list = ["PRAME", "IL13RA2", "MICB", "ICOS", "SLCO1A2", "GPR143", "GRPR", "NTSR1", "TNFRSF8", "RET", "LY6K", "RHD", "LTK", "SLC30A8", "CCR4", "TNFSF13B", "MC1R", "CCR5", "HTR3A", "MC5R", "TYR", "MCHR1", "MAL", "CTLA4", "PSCA", "SLC45A2", "SSTR5", "EPOR", "NTRK1", "HTR2B", "CHRNA5", "CRHR2", "BLNK", "CD52", "TDO2", "DRD1", "BTLA", "HTR2C", "RNF43", "FASLG", "MPL", "CSF3R", "CXCR6", "PTCH1", "FFAR4", "ABCB5", "LZTS1", "CXCR1", "NRG2", "ADORA3", "SIGLEC6", "OPRL1", "ABCB4", "CCR8", "TIGIT", "OSCAR", "CTXN1", "ABCG5", "SLC5A4", "TAS1R3", "PVRIG", "DIO2", "DRD4", "ROS1", "CXCR3", "TFR2", "GPR35", "NRG4", "BOC", "PTGDR", "LHCGR", "CD1D", "HPN", "TRPV1", "PMEL", "PMP22", "ALK", "DLL3", "EPHA5", "CD83", "XCR1", "CHRNA1", "FCGR2B", "CD226", "STAC", "ERBB3", "CXCR2", "GNRHR", "AVPR2", "BCL2L12", "SSTR1", "HCRTR1", "HCST", "ADAM12", "DCT", "GPR55", "DLL4", "HTR3B", "L1CAM", "CHRNA7"]    # List of standard nomination reasons - use EXACTLY these phrases
    standard_reasons = [
...
if __name__ == "__main__":
    ...
    def make_gene_nominations_csv(reason_data, output_path):
        ...
        return out
    make_gene_nominations_csv(all_reason_data, "/data/ep924610/project_nb/paper_code/bulk_review/new_prompt2_no_base/gene_nominations_summary.csv")
