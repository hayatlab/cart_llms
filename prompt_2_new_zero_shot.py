...
# Output directory
OUTPUT_DIR = "/data/ep924610/project_nb/paper_code/new_prompt2_zero_shot"
...
[GENES LIST: [ERBB3, RNF43, MC1R, PMEL, LZTS1, IGF1R, GPNMB, SORT1, TNFRSF14, NRG2, HPS4, NRG4, ROBO1, PTCH1, MAK, CDH1, TCHP, BLNK, LTK, PKD2, ADIPOR2, EPS8, CDH3, TNFSF13B, DDR2, NKTR, LAT, ABCB4, EPOR, BMPR2, PIGF, FHIT, ERBB2, NEO1, CHRNA5, TGFBR1, CD226, PDCD1LG2, MLLT10, EPHA2, APC, F2RL1, DST, IFNAR2, ADAM12, CTNS, TRPM7, TNK2, HTR2B, BCL2L12, FUT2, PPL, PDE4D, HCAR2, RAF1, BRAF, RASGRP1, PTK2, FCGR2B, ITGA6, WLS, RAD51B, GPER1, INSR, NPIPA1, MYO10, IL6R, GPR55, AXIN2, SLC22A1, HAS3, NF1, P2RX7, IL1RAP, PMP22, CADM1, SLC16A1, CTTN, TRPV2, LEPR, ABCA7, STIL, CNIH3, NCAM1, CRCP, GNAQ, MME, GRK4, MR1, GPC3, WDPCP, ADAM10, SLC38A6, KCNN4, SLC39A4, SLC47A1, NF2, TEC, LAPTM4B, PTCH2]
...
def extract_gene_data(response_text, model_name=None, run_id=None):
    ...
    gene_list = ['ERBB3', 'RNF43', 'MC1R', 'PMEL', 'LZTS1', 'IGF1R', 'GPNMB', 'SORT1', 'TNFRSF14', 'NRG2', 'HPS4', 'NRG4', 'ROBO1', 'PTCH1', 'MAK', 'CDH1', 'TCHP', 'BLNK', 'LTK', 'PKD2', 'ADIPOR2', 'EPS8', 'CDH3', 'TNFSF13B', 'DDR2', 'NKTR', 'LAT', 'ABCB4', 'EPOR', 'BMPR2', 'PIGF', 'FHIT', 'ERBB2', 'NEO1', 'CHRNA5', 'TGFBR1', 'CD226', 'PDCD1LG2', 'MLLT10', 'EPHA2', 'APC', 'F2RL1', 'DST', 'IFNAR2', 'ADAM12', 'CTNS', 'TRPM7', 'TNK2', 'HTR2B', 'BCL2L12', 'FUT2', 'PPL', 'PDE4D', 'HCAR2', 'RAF1', 'BRAF', 'RASGRP1', 'PTK2', 'FCGR2B', 'ITGA6', 'WLS', 'RAD51B', 'GPER1', 'INSR', 'NPIPA1', 'MYO10', 'IL6R', 'GPR55', 'AXIN2', 'SLC22A1', 'HAS3', 'NF1', 'P2RX7', 'IL1RAP', 'PMP22', 'CADM1', 'SLC16A1', 'CTTN', 'TRPV2', 'LEPR', 'ABCA7', 'STIL', 'CNIH3', 'NCAM1', 'CRCP', 'GNAQ', 'MME', 'GRK4', 'MR1', 'GPC3', 'WDPCP', 'ADAM10', 'SLC38A6', 'KCNN4', 'SLC39A4', 'SLC47A1', 'NF2', 'TEC', 'LAPTM4B', 'PTCH2']
